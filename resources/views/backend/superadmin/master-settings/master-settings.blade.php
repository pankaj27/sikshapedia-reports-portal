                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(Request::segment(3) == 'mou') active @endif"   href="{{route('mou-settings')}}">MOU Settings</a>
                        </li>
                    ...
                    <div class="darkBox p-4 pb-2">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane container @if(Request::segment(3) == 'mou') active @endif" id="mou">
                                
                                @include('backend.superadmin.master-settings.settings.mou-settings')
                            </div>
