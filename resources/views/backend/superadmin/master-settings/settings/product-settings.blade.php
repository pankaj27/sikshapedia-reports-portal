...
<div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
  ...
  @foreach($allproducts as $prod)
    @php($product_cost = DB::table('product_costs')->where('product_id',$prod->id)->where('product_cost_type','ONE-TIME')->first() )
    <div class="col">
      ...
      @endif
        ...
        <div class="card-body">
          ...
          @php($ftr = DB::table('product_costs')->where('product_id',$prod->id)->where('product_cost_type','INSTALLMENT')->get())
          @if(!empty($ftr))
          <hr>
          <ul class="list-unstyled mt-3 mb-4">
            @foreach($ftr as $ll)
