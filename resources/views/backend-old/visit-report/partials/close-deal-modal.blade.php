    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
             @php($checkProposalsend = DB::table('proposals')->where('institute_id',$orggt->id)->where('is_bill_generated',1)->first())
      ...
      <div class="row">
        ...
        <center><h3 style="color:red">Plesae generate bill first using complete deal after that close deal</h3></center>
