...
<div class="row">
    ...
    <div class="col-lg-9">
        <div class="form-group pb-3">
            <input required="required" id="product_title" name="product_title" type="text" class="form-control round-input m-2 " placeholder="Product Title" value="{{$product->product_name}}" />
...
@php($product_cost = DB::table('product_costs')->where('product_id',$product->id)->where('product_cost_type','ONE-TIME')->first())


@php($product_installment = DB::table('product_costs')->where('product_id',$product->id)->where('product_cost_type','INSTALLMENT')->get())
...
<div class="row">
    ...
    <div class="col-lg-9">
        <div class="form-group pb-3">
            <input required="required" id="product_one_time_cost" name="product_one_time_cost" type="text"  class="form-control round-input m-2" placeholder="Product one time cost" value="{{$product_cost->product_cost}}" />
...
<div class="row">
    ...
    <div class="row" id="btndele_{{$sdd}}" style="border:dotted 1px #ea5c39; padding:5px; border-radius:5px;">
        <div class="col-lg-3">
            <div class="form-group pb-3">
                <div class="d-flex justify-content-between mb-2" >
    ...
    <div class="col-lg-2">
        <div class="form-group pb-3">
            ...
            <input  id="installment_duration_{{$sdd}}" name="installment_duration_{{$sdd}}" type="number"
              class="form-control round-input m-2 " placeholder="Duration  " value="{{$productins->instalment_duration}}"  />
    ...
    <div class="col-lg-2">
        <div class="form-group pb-3 mt-2">
            ...
            <select class="form-control round-input" name="duration_unit_{{$sdd}}" id="duration_unit_{{$sdd}}">
                <option value="Days">Days</option>
                <option value="Weeks">Weeks</option>
                <option value="Moths">Months</option>
    ...
    <div class="col-lg-2">
        <div class="form-group pb-3">
            <input id="installment_no_{{$sdd}}" name="installment_no_{{$sdd}}" type="text"
              class="form-control round-input m-2 " placeholder="Installment no Ex: 2 " value=""  />
    ...
    <div class="col-lg-2">
        <div class="form-group pb-3">
            ...
            <input  id="installment_cost_{{$sdd}}" name="installment_cost_{{$sdd}}" type="text"
              class="form-control round-input m-2 " placeholder="Installment cost " value=""   />
        </div>
    </div>
    <div class="col-lg-2">
        <div class="form-group pb-3">
            ...
            <input  id="installment_duration_{{$sdd}}" name="installment_duration_{{$sdd}}" type="number"
              class="form-control round-input m-2 " placeholder="Duration  " value=""  />
    ...
    <div class="col-lg-8">
        <div class="form-group pb-3">
            ...
            <input  id="installment_terms_{{$sdd}}" name="installment_terms_{{$sdd}}" type="text"
              class="form-control round-input m-2 " placeholder="Installment terms  " value=""  />
    ...
    <div class="col-lg-2">
        <div class="form-group pb-3">
            ...
            <input  id="installment_duration_1" name="installment_duration_1" type="number"
              class="form-control round-input m-2 " placeholder="Duration  "  />
    ...
    <div class="col-lg-2">
        <div class="form-group pb-3 mt-2">
            ...
            <select class="form-control round-input" name="duration_unit_1" id="duration_unit_1">
                <option value="Days">Days</option>
                <option value="Weeks">Weeks</option>
                <option value="Moths">Months</option>
                <option value="Years">Years</option>
    ...
    <div class="col-12">
        <button type="submit" class="btn btn-primary menu btn-sm " style="float:right;" onclick="add_more_installment()">Add More  Installment</button>
...
<script>
    ...
    function add_more_installment(){
        ...
        $("#installmentno").val(newfeatures_number);
            ...
            var emp = '';
            emp += '<div class="row" id="btndele_'+newfeatures_number+'" style="border:dotted 1px #ea5c39; padding:5px; border-radius:5px;"><div class="col-lg-3">';
            ...
            emp +='<input required="required" id="installment_duration_'+newfeatures_number+'" name="installment_duration_'+newfeatures_number+'" type="text" class="form-control round-input m-2 " placeholder="Duration "  />';
            emp +='</div>';
            emp +='</div>';
            ...
            emp +='<select class="form-control round-input" name="duration_unit_'+newfeatures_number+'" id="duration_unit_'+newfeatures_number+'"><option value="Days">Days</option><option value="Weeks">Weeks</option><option value="Moths">Months</option><option value="Years">Years</option></select>';
            emp +='</div>';
            emp +='</div>';
